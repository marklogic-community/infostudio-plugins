...
as empty-sequence()
{
    ...
    let $transactions :=
        ...
        let $put :=
            ...
            let $id := fn:concat(fn:string(fn:replace($entry/title, " ", "-")),".xml")
            ...
            <body>
              ...
              <form style="margin-top: 20px;" action="{$submit-here}" method="post">
                  ...
                  <p style="color: rgb(125,125,125); font-style: italic;">
                    The feed URI. This feed is assumed to be well-formed RSS and its contents must be readable by MarkLogic.
                  </p>
